---
name: ui-enhancement
description: "Tactics Flame の UI/UX 改善を専門とするエージェント。LibGDX の ShapeRenderer + BitmapFont を使い、FitViewport 800×480 の制約内でゲーム画面のユーザビリティと視認性を向上させる。"
